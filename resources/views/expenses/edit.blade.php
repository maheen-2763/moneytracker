        ...
        <form method="POST"
            ...
            <div class="mb-4">
                ...
                <textarea name="description"
                          ...
                          class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2
                                 text-gray-900 dark:text-white dark:bg-gray-700
                                 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $expense->description) }}</textarea>
            </div>

            {{-- Receipt --}}
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Receipt <span class="text-gray-400 text-xs">(optional)</span>
                </label>
                @if($expense->receipt_path)
                    <p class="text-sm text-green-600 mb-1">✓ Receipt already uploaded</p>
                @endif
                <input type="file"
                       name="receipt"
